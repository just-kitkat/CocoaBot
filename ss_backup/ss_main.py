...
# Second Serving - A feature rich economy bot!
# This code belongs to kitkat3141. Please do not copy this code or reproduce it in any way. If you want permission to recreate part of the bot's features, please contact kitkat3141 on discord. Thank you.
# If you want to use part of this code, please ask kitkat3141#0422 on discord first. 
# Credit Second Serving if you have taken inspiration from it :D
    ...
    async def guild_xp(self, ctx, xp):
      ...
      if bot.db["economy"]["users"][str(user)]["guild"] != "":
        ...
        if bot.db["economy"]["guild"][guild_name]["xp"] >= guild_xpneeded:
          ...
          guild_xp = int(bot.db["economy"]["guild"][guild_name]["xp"])
          emoji = ""
          xp_emoji = "🟩"
          no_xp_emoji = "⬛"
